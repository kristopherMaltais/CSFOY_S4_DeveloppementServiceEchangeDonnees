...
namespace M01_Srv_Municipalite
{
    public class Municipalite
    {
        ...
        // ** Constructeurs ** //
        public Municipalite(int p_codeGeographique, string p_nomMunicipalite, string p_adresseCourriel, string p_adresseWeb, DateTime? p_dateProchaineElectection, bool p_estActif)
        {
